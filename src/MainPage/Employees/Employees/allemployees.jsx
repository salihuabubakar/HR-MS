    ...
    <div className={`main-wrapper ${menu ? 'slide-nav': ''}`}> 
      ...
      <div className="content container-fluid">
        ...
        <div className="row staff-grid-row">
          ...
          {staffs?.map(staff => {
            const { staff_id, name, designation, img, house_id } = staff;
            return (
              <div key={staff_id} className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                <div className="profile-widget">
                  <div className="profile-img">
                    <Link to="/app/profile/employee-profile" className="avatar"><img src={img} alt="" /></Link>
                  </div>
                  ...
                  <h4 className="user-name m-t-10 mb-0 text-ellipsis"><Link to="/app/profile/employee-profile">{name}</Link></h4>
